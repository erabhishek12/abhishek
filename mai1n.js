...
document.addEventListener('keydown', (e) => {
    if (e.key === konamiCode[konamiIndex]) {
        ...
        if (konamiIndex === konamiCode.length) {
            alert('🎮 KONAMI CODE ACTIVATED! Access Key: ABHI-TURBO-2025');
            konamiIndex = 0;
        }
    } else {
        konamiIndex = 0;
...
// CONSOLE MESSAGE
// ===================================
console.log('%c🚀 ABHISHEK KUMAR PORTFOLIO', 'color: #00ff41; font-size: 20px; font-weight: bold;');
console.log('%c⚡ Cybersecurity Specialist | Ethical Hacker | AI Developer', 'color: #64ffda; font-size: 14px;');
console.log('%c💼 Looking to hire? Email: abhishekyadav954698@gmail.com', 'color: #8892b0; font-size: 12px;');
console.log('%c🔐 Easter Egg: Try the Konami Code!', 'color: #ff00c1; font-size: 12px;');